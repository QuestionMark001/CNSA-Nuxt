 ...
 * @LastEditTime: 2024-04-08 18:50:54
...
<template>
    <div class="w-full h-20 fixed bg-white shadow-md z-50">
        <div class="lg:w-80 text-left w-64">
            <NuxtImg src="/CNSA_logo.png" class="lg:left-16 fixed w-20 top-0 left-0" title="CNSA" />
        ...
        class="lg:inline-flex lg:top-3 lg:flex-row lg:text-lg lg:p-0 lg:gap-8 lg:font-medium
